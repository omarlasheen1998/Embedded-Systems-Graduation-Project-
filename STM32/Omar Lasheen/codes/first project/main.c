...
{	
	...
	{	
...
#ifdef	 MASTER_EN
		I2C_master_rx(MI2C1,SLAVE_ADDRESS,receive_data,5);
		//STK_voidDelay_ms(100);
		//I2C_master_tx(MI2C1,SLAVE_ADDRESS,send_data,1);
		...
		I2C_slave_tx(MI2C1,send_data,5);
		//I2C_slave_rx(MI2C1,receive_data,1);
