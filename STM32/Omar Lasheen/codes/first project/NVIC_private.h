...
#define NVIC_Base_Address     (u32)(0xE000E100)      //define the boundary address of NVIC
#define SCB_Base_Address       (u32)(0xE000ED00)	   //define the boundary address of SCB
...
#define NVIC_IABR0			*((volatile volatile u32 *)(NVIC_Base_Address + 0x200))
#define NVIC_IABR1			*((volatile volatile u32 *)(NVIC_Base_Address + 0x204))
//#define NVIC_IABR2			*((volatile volatile u32 *)(NVIC_Base_Address + 0x208))
