/* The program shows "The world is but one country" on the LCD */
...
void lcd_init()
{
	...
	lcd_command(0x33);		/* send 0x33 for init. */
	lcd_command(0x32);		/* send 0x32 for init. */
	lcd_command(0x28);		/* init. LCD 2 line,5x7 matrix */
