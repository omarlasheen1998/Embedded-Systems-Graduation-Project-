...
int main()
{
	...
	}while(i2c_sendAddrForWrite(0x68) != 0);	/* repeat if arbitration lost */
	
	i2c_sendData(0x0); /* set addr. pointer to 0 */
	i2c_sendData(0x35); /* second */
	i2c_sendData(0x14); /* min */
	i2c_sendData(0x19); /* hour */
	i2c_sendData(0x07); /* day of week */
	i2c_sendData(0x15); /* day of month */
	i2c_sendData(0x09); 	/* month */
	i2c_sendData(0x19); 	/* year */
